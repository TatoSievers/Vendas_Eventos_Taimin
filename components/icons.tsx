...
// This icon is fine for CPF as it represents identification.
...
export const BuildingOfficeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M8.25 21V3.75M12 21V3.75m3.75 17.25V3.75M4.5 12h15m-15 0a48.108 48.108 0 0 0 2.25 6.313m10.5-6.313a48.108 48.108 0 0 1 2.25 6.313M4.5 12V6a1.5 1.5 0 0 1 1.5-1.5h10.5a1.5 1.5 0 0 1 1.5 1.5v6m-13.5 0c0 2.625 1.5 4.875 3.75 4.875h7.5c2.25 0 3.75-2.25 3.75-4.875M4.5 12h15" />
  </svg>
);
