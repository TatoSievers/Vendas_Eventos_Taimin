...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  // Responde a verificações de segurança do navegador (preflight requests)
  ...
  // Este arquivo só aceita o método POST
  if (req.method !== 'POST') {
  ...
  try {
    ...
    console.error('ERRO CRÍTICO EM POST /api/sales:', error);
